...
export const LoginForm = props => (
    <div className={styles.formComponent}>
        <form className={styles.form}>
            ...
            <input type='password' placeholer='Password' className={styles.textInput} />
...
export const SignupForm = props => (
    <div className={styles.formComponent}>
        ...
        <p className={styles.terms}>By signing up, you agree to our <span>Terms & Privacy Policy</span></p>
    </div>
);